...
module.exports = {
  ...
  */
  ...
  getToday(formatStr) {
    if (formatStr) return moment().format(formatStr);
    return moment()
  ...
  getFirstDayOfThisMonth(formatStr) {
    ...
    if (formatStr) return m.format(formatStr);
    return m;
  ...
  // Trả về mảng tất cả các ngày trong tháng (dạng YYYY-MM-DD)
  // month: 1 ~ 12
  ...
  // Đổi từ M/D/Y sang YYYY-MM-DD
  // Dùng trong hàm import excel bảng công
