...
import View from 'views/Category/Edit'
...
class Edit extends BaseContainer {
  ...
  componentDidMount() {
    ...
    this.props.dispatch(CategoryAction.fetch({ _id: this.id }))
  ...
  onSubmit(values) {
    ...
    this.props.dispatch(CategoryAction.edit({
      _id: this.id,
      ...values
    }))
    .then(data =>{
...
const mapStateToProps = state => {
  return {
    ...
    data: selector(state, "category.item", {}),
